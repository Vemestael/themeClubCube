<div class="b-tabs__pane-item col-xs-12 [[!getTemplateValues? &id=`[[*template]]` &currentChunck=`eventsRectangleItem`]]">
    <div class="c-box c-box-v">
        <div class="c-box__inner">
            ...
            <div data-bgimage="[[+img]]" class="b-box__img-wrap b-box__grdnt-a bg-image"></div>
            <div class="c-box__link-wrap">
                <div class="btn-pointer__wrap">
                    <a class="btn btn-pointer" href="[[~[[+id]]]]"><span class="btn-pointer__txt">More</span></a>
