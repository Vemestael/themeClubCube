...
appMakeBeCool.gateway.addClass('ThemeMode', function (properties, $, $window, $document) {
    ...
    //PRIVATE METHODS
        ...
        _extendClasses = function () {
            ...
            _globals.siteObj.utils.extend(_globals.siteObj.classes.MainMenu, _globals.siteObj.base.Class);
        },
        ...
        _instantiateClasses = function () {
            ...
            _globals.siteObj.createClassInstance('MainMenu', _globals.siteObj.classes.MainMenu, {classId: 'MainMenu'});
        },
            ...
            return {
                setCompleteBind: function () {
                    _themeMode.bind($window, _themeMode.globals.classType + '_Complete', function (e, data) {
                        ...
                        _themeMode.trigger('MainMenu_Init', data);
                    });
                }
            }
        },
