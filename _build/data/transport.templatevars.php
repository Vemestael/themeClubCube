...
$tmp = array(
    'viewType' => array(
        ...
        'elements' => 'Type 1==a||Type 2==b||Type 3==c',
        'display' => 'default',
        'default_text' => 'a',
    ),
    'img' => array(
    ...
    'eventHeaderViewType' => array(
        ...
        'caption' => 'Header display type at the opening of Event',
        'elements' => 'Date + cost==1||Countdown to Event==2',
        'display' => 'default',
        'default_text' => '1',
    ),
    'audioLink' => array(
    ...
    'audioViewType' => array(
        'type' => 'option',
        'name' => 'audioViewType',
        'caption' => 'Display type of player',
        'elements' => 'With playlist==1||Only one track==2',
        'display' => 'default',
        'default_text' => '1',
    ),
    'blogViewType' => array(
        'type' => 'option',
        'name' => 'blogViewType',
        'caption' => 'Display type of article blog',
        'elements' => 'Type 1==b-box||Type 2==b-box b-box-sm||Type 3==b-box b-box--clr-a||Type 4==b-box b-box--clr-b||Type 5==b-box b-box-sm b-box--clr-b',
        'display' => 'default',
        'default_text' => 'b-box',
    ),
    'twitterLogin' => array(
    ...
    'typeSidebar' => array(
        'type' => 'option',
        'name' => 'typeSidebar',
        'caption' => 'Display type sidebar',
        'elements' => 'Small blocks==1||Large blocks==2',
        'display' => 'default',
        'default_text' => '2',
    ),
    'eventViewType' => array(
