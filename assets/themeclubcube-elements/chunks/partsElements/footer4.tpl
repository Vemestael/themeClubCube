<footer id="footer4" class="b-footer">
    <div class="container">
        <div class="row">
            <div class="b-footer__item col-xs-12 col-sm-6 col-lg-4">
                ...
                <div class="b-footer__contacts">
                    <address class="b-footer__adrs col-xs-12">87500 Mariupol, Ukraine, ul. Kazantseva 7b, 2nd floor, office. 29</address>
                    <div class="b-footer__contacts-mail indent col-xs-12"><a href="mailto:hello@cubeclub.com" class="link">hello@cubeclub.com</a></div>
