<div class="c-box c-box--lg col-xs-12 col-md-6">
    <div class="c-box__inner">
        <div class="c-box__cont">
            <h2 class="c-box__ttl-s2">[[+pagetitle]]</h2>
            <hr class="hr-pattern">
            <p class="c-box__txt c-box__txt--display">[[+longtitle]]</p>
        </div>
        <div data-bgimage="../uploads/gallery/Gallery_02_Original.jpg" class="b-box__img-wrap b-box__grdnt-b bg-image"></div>
        <div class="c-box__date-item c-box__date-item--float">
            <time datetime="[[+timeStart]]" class="date c-box__date c-box__date--lg"><span class="date__dt">[[+timeStart:strtotime:date=`%d`]]</span><span class="date__rh"><span class="date__rh-m">[[%lf_month_short.[[+timeStart:strtotime:date=`%m`]]]]</span><span class="date__rh-d">[[+timeStart:strtotime:date=`%Y`]]</span></span></time>
        </div>
