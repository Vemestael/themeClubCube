<footer id="footer2" class="b-footer">
    <div class="container">
        <div class="row">
            <div class="b-footer__item col-xs-12 col-lg-3">
                <h6 class="s6-heading">twitter feed</h6>
                <div class="b-footer__inner b-footer__twitter"><span class="fa fa-twitter"></span>
                    <p class="b-footer__txt">
                        ...
                        hard" - Caterina Fake
                        <a class="link" href="#">#wdd</a> <a class="link" href="/">#quote</a>
                ...
                <div class="b-footer__inner b-footer__twitter"><span class="fa fa-twitter"></span>
                    <p class="b-footer__txt">
                        RT <a class="link" href="/">@DesignerDepot</a>: H.264 still accounts for most video encoding today, but HEVC/H.265 and
                        VP9 are beginning to make noise.”
                        <a href="/" class="link link--dash"> http://t.co/f1YGnPSijD http://t.co/f1YGnPSijD</a>
                    </p><span class="b-footer__days">
                  -47 days ago
                  </span>
                </div>
                <div class="b-footer__inner b-footer__twitter"><span class="fa fa-twitter"></span>
                    <p class="b-footer__txt">
                        RT <a class="link" href="/">@DesignerDepot</a>: A new series of water-activated artworks on Seattle sidewalks that only
            ...
            <div class="b-footer__item col-xs-12 col-lg-8 col-lg-offset-1">
                <div class="b-footer__msg">
                    <div class="b-msg">
                        <div class="b-msg__corner"></div>
                        <p class="b-msg__txt small-txt">We like to create cool parties and we love to chat with like-minded</p><strong>Do not hesitate to say hello!</strong>
                    </div>
                </div>
                <div class="b-footer__contacts">
                    <address class="b-footer__adrs col-sm-4 col-lg-12">87500 Mariupol, Ukraine, ul. Kazantseva 7b, 2nd floor, office. 29</address>
                    <div class="b-footer__contacts-mail col-sm-4 col-lg-12"><a href="mailto:hello@cubeclub.com" class="link">hello@cubeclub.com</a></div>
                    <ul class="b-footer__contacts-phones col-sm-4 col-lg-12">
                        <li><a href="tel:+380505884637">+38 (050) 588-46-37</a></li>
                        <li><a href="tel:+380977984512">+38 (097) 798-45-12</a></li>
                    </ul>
                </div>
                <hr class="hr-line">
                ...
                <div class="b-footer__item-last">
                    <p class="b-footer__copyrights x-small-txt">&copy; 2016 — Cube Club Theme by <a class="link" href="http://makebecool.com">makebecool</a> All Rights Reserved</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="js/jquery/plugins/flexibility.js"></script>
<script src="js/jquery/plugins/jquery.syotimer.js"></script>
...
<script src="js/app/modules/imgHover.js"></script>
<script src="js/app/modules/slickSlider.js"></script>
<script src="js/app/modules/timer.js"></script>
