	...
	<a href="[[+image]]" class="gallery-tile">
        <img alt="[[+pagetitle:htmlent]]" title="[[+longtitle:htmlent:default=`[[+pagetitle:htmlent]]`]]" class="img-responsive img-preload"
             data-src="<768:[[+image:phpthumbof=`w=360&h=202&zc=1`]],
					>767:[[+image:phpthumbof=`w=485&h=272&zc=1`]],
					>1199:[[+image:phpthumbof=`w=360&h=202&zc=1`]]"
             data-src2x="<768:[[+image:phpthumbof=`w=720&h=404&zc=1`]],
                >767:[[+image:phpthumbof=`w=970&h=544&zc=1`]],
				>1199:[[+image:phpthumbof=`w=720&h=404&zc=1`]]"
             src="[[+image:phpthumbof=`w=360&h=202&zc=1`]]">
	</a>
</div>